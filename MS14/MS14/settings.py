...
SESSION_COOKIE_NAME = "ms14_sessionid14"
...
WSGI_APPLICATION = 'MS14.wsgi.application'
...
if not PROJECT_SERVICE_URL:
    print("WARNING: PROJECT_SERVICE_URL not set. Internal clients will fail.")

if not NODE_SERVICE_URL:
    print("WARNING: NODE_SERVICE_URL not set. Internal clients will fail.")
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "graphcontrol.custom_auth.ForceTokenUserJWTAuthentication", # <<< YOUR CUSTOM AUTH CLASS
    ),
