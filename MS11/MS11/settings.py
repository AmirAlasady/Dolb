...
SESSION_COOKIE_NAME = "proj_sessionid11"
...
if not SECRET_KEY:
    ...
    SECRET_KEY = 'django-insecure-4g45gnrtnfallback-dev-key-!!change-me!!'
...
WSGI_APPLICATION = 'MS11.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "rag_control_plane.custom_auth.ForceTokenUserJWTAuthentication", # <<< YOUR CUSTOM AUTH CLASS
    ),
...
CHROMA_DB_PORT = int(os.getenv('CHROMA_DB_PORT', 8777))
